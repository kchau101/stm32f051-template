#Based on the stm32f0-discovery-basic-template by szczys
...
STD_PERIPH_LIB=../stm32f0-discovery-basic-template/Libraries

# Location of the linker scripts
LDSCRIPT_INC=../stm32f0-discovery-basic-template/Device/ldscripts

# location of OpenOCD Board .cfg files (only used with 'make program')
OPENOCD_BOARD_DIR=/usr/share/openocd/scripts/board

# Configuration (cfg) file containing programming directives for OpenOCD
OPENOCD_PROC_FILE=../stm32f0-discovery-basic-template/extra/stm32f0-openocd.cfg
...
SRCS += $(STD_PERIPH_LIB)/../Device/startup_stm32f0xx.s # add startup file to build
